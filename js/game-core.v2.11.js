...
function renderCasino(){try{mccInitCasino()}catch(err){console.error('Meme casino render error',err)}const cash=$('#casinoCashReadout');if(cash)cash.textContent=fmt(state.cash)}
  ...
  /* ==========================================================
     ...
     ========================================================== */
  const PF_UPDATE_ID='v36-ghost-jet-odds-potion-cleanup-20260913';
  const PF_VERSION='3.6';
  ...
  pfV35HealthCheck=function(){
    ...
    const checks=[
      ...
      ['Odds engine',typeof pfRenderOddsBrowser==='function'],['Jet rarity odds',JET_LUMAGUI_CARD_CHANCE===1/1000],['Jet sell value',sellValue(JET_LUMAGUI_CARD,1,{variant:'Normal'})===420],['Jet power',JET_LUMAGUI_CARD.power===1],
